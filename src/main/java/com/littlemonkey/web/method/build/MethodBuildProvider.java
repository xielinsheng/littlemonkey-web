...
public interface MethodBuildProvider {
    ...
    default void resolve(RequestDetail requestDetail, MethodDetail methodDetail, RequestBody body, List<Object> params){
            ...
            public void accept(String paramName, GenericType genericType) {
                ...
                for (String beanName : beanNames) {
                    ...
                    if (webHandlerMethodArgResolver.supportsParameter(methodDetail)) {
                        params.add(webHandlerMethodArgResolver.resolveArgument(methodParameter, body.getContent()));
                        break;
                    }
                }
            }
